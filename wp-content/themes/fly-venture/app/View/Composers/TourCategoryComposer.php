...
class TourCategoryComposer extends Composer
{
    /**
     ...
     * @var array
     */
    protected static $views = ['partials.content-taxonomy-tour-category'];
    ...
    {
        return [
            'taxPageContentData' => $this->taxPageContentData(),
        ];
    }

    /**
     * Returns values from ACF group: page-content (fetched from the current taxonomy term).
     *
     * @return array
     */
    protected function taxPageContentData(): array
    {
        return [
    ...
    /**
     * Flexible content parser for page_content assigned to the taxonomy term.
     *
     * @return array
     */
    protected function buildPageContentData(): array
    {
        $term_id = get_queried_object_id();
        $object  = 'term_' . $term_id;

        $data             = [];
        $flexible_content = get_field('page_content', $object);
        ...
        foreach ($flexible_content as $content) {
            ...
            if ('customize_your_experience_section' === $layout) {
                $data[] = (object) [
                    'layout'               => $layout,
                    'layout_bg_color'      => $content['layout_bg_color']      ?? null,
            ...
            if ('two_image_with_content' === $layout) {
                $data[] = (object) [
                    'layout'         => $layout,
            ...
            if ('cta_bg_image_with_content' === $layout) {
                $data[] = (object) [
                    'layout'                   => $layout,
            ...
            if ('our_most_popular_tours_section' === $layout) {
                $data[] = (object) [
                    'layout'                         => $layout,
                    'background_color'               => $content['background_color']               ?? null,
            ...
            if ('what_you_will_see_section' === $layout) {
                $data[] = (object) [
                    'layout'           => $layout,
            ...
            if ('tour_section_with_load_more' === $layout) {
                $data[] = (object) [
                    'layout'                => $layout,
                    'background_color'      => $content['background_color']      ?? null,
                    'ompt_icon'             => $content['ompt_icon']             ?? null,
            ...
            if ('image_with_content_section' === $layout) {
                $data[] = (object) [
                    'layout'               => $layout,
            ...
            if ('what_sets_us_apart_section' === $layout) {
                $data[] = (object) [
                    'layout'                => $layout,
