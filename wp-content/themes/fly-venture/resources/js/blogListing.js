const initBlogListing = () => {
  ...
  const buildPostCard = (post) => {
    ...
    return `<div class="popular-tour-card">
      <a href="${post.permalink}" aria-label="${escAttr(post.title)}">
          ...
          <div class="popular-tour-metas">
            <div class="flex gap-10 items-center mb-16">
              <div class="flex items-center gap-6 w-1/2">
                ...
                <div class="content"><a href="${escAttr(post.author_url || '')}"><p>${escHtml(post.author)}</p></a></div>
              </div>
              <div class="flex items-center gap-6 w-1/2">
                <div class="author">
  ...
  const fetchPosts = (page = 1) => {
    ...
    xhr.done((response) => {
      ...
      // Update URL to reflect current page without reloading
      ...
      history.pushState({ paged }, '', url.toString());
    });
