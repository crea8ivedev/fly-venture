...
<footer class="site-footer">
  <div class="container-fluid">
    <div class="footer-top">
      ...
      {{-- Footer Logo --}}
      <div class="footer-col footer-logo-col max-1023:w-full max-1023:justify-center 1024:pr-30 1600:pr-60">
    ...
    <div class="footer-bottom flex flex-wrap justify-between w-full items-center gap-24 max-1023:justify-center">
      ...
      <div class="footer-bottom-menu">
        {{-- <a href="#" class="text-white! text-body-2 leading-24 hover:text-orange!" aria-label="Terms & Conditions"
          role="link">--}}
          {{-- Terms & Conditions--}}
          {{-- </a>--}}
  ...
  <div class="fv-offer-popup" id="fv-offer-popup" aria-hidden="true">
    ...
    <div class="fv-card-container">
      <div class="fv-offer-popup__card" role="dialog" aria-modal="true" aria-labelledby="fv-offer-popup-title">


        <div class="fv-offer-popup__content">

          <button type="button" class="fv-offer-popup__close" aria-label="{{ esc_attr__('Close popup', 'textdomain') }}"
            data-popup-close>
            &times;
          </button>
          {{-- Lead Text --}}
          ...
          <a href="{{ esc_url($popup_button_url) }}" class="btn btn-orange"
