...
<!-- testimonial-start -->
<section class="{{ $section_classes }}" @if ( ! empty( $section_id ) ) id="{{ esc_attr( $section_id ) }}" @endif>
      ...
      <div class="flex flex-col justify-center items-center gap-40 text-center fadeText">
        <div class="container-fluid flex flex-col justify-center items-center gap-45 max-1199:gap-30 text-center fadeText">
          ...
          <div class="icon">
            ...
            <img data-src="{{ esc_url( $_img ) }}" data-sizes="auto" height="100" width="100" alt=""
              class="w-full h-full object-cover max-w-100 max-h-100 max-1199:max-w-50 max-1199:max-h-50 lazyload">
            @endif
          </div>
          @endif
            ...
            <a href="{{ esc_url( $btn_link['url'] ) }}" class="btn-review"
              ...
              <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="url(#paint0_linear_2195_3507)" />
                <defs>
                  <linearGradient id="paint0_linear_2195_3507" x1="0" y1="8.17791" x2="17.1139" y2="8.17791"
        ...
        @endif
        @if ( ! empty( $content->view_all_button ) )
          @php( $_link = $content->view_all_button )
          <div class="btn-custom">
